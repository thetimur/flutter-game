...
class Palette {
  ...
  Color get darkPen => const Color(0xff04672b);
  ...
  Color get backgroundMain => const Color(0xff8fc7a0);
  Color get backgroundLevelSelection => const Color(0xff8fc7a0);
  Color get backgroundPlaySession => const Color(0xff8fc7a0);
